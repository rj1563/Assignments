...
# pattern = 'https://twitter.com/([_0-9a-z]+)'
...
# 3. Companies in europe reports their financial numbers of semi annual basis and you can have a 
# document like this. To extract quarterly and semi annual period you can use a regex as shown below
...
pattern1 = r'FY(\d{4} (?:...S[1-2]|Q[1-4]))'
pattern2 = r'FY(\d{4} (?:S[1-2]|Q[1-4]))'
